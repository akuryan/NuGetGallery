...
set sitedir="%CD%\src\NuGetGallery"
set project=NuGetGallery
...
%appcmdpath%\appcmd set site /site.name:"colours-%project%" /+bindings.[protocol='http',bindingInformation='*:80:nuget.localtest.me']
...
echo. >> %hostspath%
echo 127.0.0.1		nuget.localtest.me >> %hostspath%
